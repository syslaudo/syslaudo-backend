...
export class createTablesPedidosExamesRecomendacoesPacientes1616460419513 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.createUniqueConstraint('pacientes', new TableUnique({
            columnNames: ['id_paciente'],
            name: 'unique_id_paciente'
        }));

        await queryRunner.createUniqueConstraint('exames', new TableUnique({
            columnNames: ['id_exame'],
            name: 'unique_id_exame'
        }));

        await queryRunner.createUniqueConstraint('recomendacoes', new TableUnique({
            columnNames: ['id_recomendacao'],
            name: 'unique_id_recomendacao'
        }));

        await queryRunner.createUniqueConstraint('pedidos', new TableUnique({
        ...
        await queryRunner.createForeignKey('recomendacoes', new TableForeignKey({
